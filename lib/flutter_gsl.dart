...
//
// /// The dynamic library in which the symbols for [FlutterGslBindings] can be found.
...
// final FlutterGslBindings _bindings = FlutterGslBindings(_dylib);
//
//
...
final DynamicLibrary _dylib = Platform.isAndroid
    ? DynamicLibrary.open('libflutter_gsl.so')
